...
class HealthCategoryScreen extends StatefulWidget {
  ...
  @override
  _HealthCategoryScreenState createState() => _HealthCategoryScreenState();
}
...
class _HealthCategoryScreenState extends State<HealthCategoryScreen> {
  ...
  void getData() async {
    ...
    await articleService.getNewsData(countryCode: 'us', category: 'health');
    await articleService.getNewsData(countryCode: 'gb', category: 'health');

    _articles = articleService.fetchArticles();
    _healthArticles = articleService.fetchArticles();
    setState(() {
      isLoading = false;
    });
  }
              ...
              children: [
                ...
                Center(
                  child: Wrap(
                    ...
                    children: _healthArticles.map((e) {
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
