...
class SportsCategoryScreen extends StatefulWidget {
  const SportsCategoryScreen({Key? key}) : super(key: key);

  @override
  _SportsCategoryScreenState createState() => _SportsCategoryScreenState();
}

class _SportsCategoryScreenState extends State<SportsCategoryScreen> {
  bool isLoading = true;
  ...
  void getData() async {
    ...
    await articleService.getNewsData(countryCode: 'ng', category: 'sports');
    await articleService.getNewsData(countryCode: 'gb', category: 'sports');

    _articles = articleService.fetchArticles();
    _sportArticles = articleService.fetchArticles();
    setState(() {
      isLoading = false;
    });
  }
